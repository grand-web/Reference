...
<!-- *Краткое описание документа* (аннотация)(ограничение до 150 символов) 
...
> 💡 Для СЕО (поисковая оптимизация) рекомендуется уделять внимание в первую очередь более влиятельным тегам — **Title**, **Description** — и по желанию заполнять Keywords.
>
> 🔥 Существуют рекомендации по правильному использованию метатегов от [Гугла](https://developers.google.com/search/docs/crawling-indexing/special-tags?visit_id=638048879691882368-915805513&rd=1) и [Яндекса](https://yandex.ru/support/webmaster/controlling-robot/html.html)
