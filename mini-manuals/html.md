...
Тегу `<html>` обычно добавляют важный атрибут `lang` (англ. «language»), например:
`<html lang="ru">`
...
Вот пример [валидного](https://validator.w3.org/) html-документа, с подключенным файлом стиля и скрипта:
