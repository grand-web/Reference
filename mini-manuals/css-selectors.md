...
Добавить псеводклассы, псевдоэлементы-
 -->
 <!-- TODO СРАВНИТЬ С MDN  -->
...
> 💡 Селектор `id` можно использовать для "якоря" в тектовых файлах. В большинстве случаев в современной вёрстке используют задание якоря в HTML при помощи атрибута `id`, однако есть движки или отдельные модули, для работы которых принципиально важно чтобы он был задан через атрибут `name`.
